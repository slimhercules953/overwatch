   ...
   const value =  interaction.options.getString('character');
    switch (value) {
        ...
        const anaEmbed = new EmbedBuilder()
  			...
  			.addFields(
        { name: 'Damage/healing with rifle', value: `75 damage/healing over 0.58 seconds`, inline: true },
        { name: 'Rate of Fire', value: `0.8 seconds between shots`, inline: true },
        { name: 'Ammo', value: `15 shots in her biotic rifle`, inline: true },
        { name: 'Projectile speed', value: `125 meters per second unscoped`, inline: true },
        { name: 'Aim type', value: `Unscoped: Projectile\nScoped: Hitscan`, inline: true },
            )
  			.setThumbnail(
      ...
      break;
      case 'hero_ana':
        const heroAnaEmbed = new EmbedBuilder()
  			.setColor("#4a4c4e")
  			.setTitle("You're powered up, get in there.")
  			.addFields(
        { name: 'Testing', value: `75 damage/healing over 0.58 seconds`, inline: true },
        { name: 'Rate of Fire', value: `0.8 seconds between shots`, inline: true },
        { name: 'Ammo', value: `15 shots in her biotic rifle`, inline: true },
        { name: 'Projectile speed', value: `125 meters per second unscoped`, inline: true },
        { name: 'Aim type', value: `Unscoped: Projectile\nScoped: Hitscan`, inline: true },
        ...
        interaction.reply({ embeds: [heroAnaEmbed]});
      break;
